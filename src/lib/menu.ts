...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    name: "Honey Latte",
    description: "Real organic honey, nutty rich espresso, and creamy steamed milk.",
    category: "Espresso",
    sizes: sizesSL(500, 550),
    modifiers: BARISTA_MODS,
  },
  ...
  // ── Coffee ──
  {
    ...
    name: "Drip Coffee",
    description: "Our house coffee, expertly ground and slow-brewed over 8 minutes for a perfectly balanced cup.",
    category: "Coffee",
  ...
  },
  {
    ...
    description: "Slow, natural brew infused with compressed nitrogen for a rich, creamy, smooth, and cool finish.",
    category: "Coffee",
  ...
  },
  {
    ...
    description: "Our nitro brew topped with house-made cold foam for an extra luxurious finish.",
    category: "Coffee",
  ...
  // ── Refreshing Drinks ──
  {
    ...
    description: "Italian sparkling water, rich passionfruit sauce, and sweet flavor.",
